...
use CommissionTask\Components\TransactionDataValidators\Exceptions\Interfaces\TransactionDataValidatorException as TransactionDataValidatorExceptionContract;
