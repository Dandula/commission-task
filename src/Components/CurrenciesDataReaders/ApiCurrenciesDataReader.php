...
namespace CommissionTask\Components\CurrenciesDataReaders;

use CommissionTask\Components\CurrenciesDataReaders\Exceptions\ApiCurrenciesDataReaderException;
